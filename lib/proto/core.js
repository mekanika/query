...
exports.include = function (fields) {
  ...
  return _select.call( this, this.qe, 'include', fields );
};
...
exports.exclude = function ( fields ) {
  if ( this.qe.include ) throw new Error('Cannot exclude after include');
  return _select.call( this, this.qe, 'exclude', fields );
};
