...
exports.update = function( ids, update, cb ) {
  if (cb && typeof cb !== 'function')
  ...
  if (update) _addTo( 'body', this.qe, update );
...
exports.done = function( cb ) {
  ...
  var pre = _join( hooks.pre.all, hooks.pre[ qo.do ] );
  var self = this;
  ...
  var post = _join( hooks.post.all, hooks.post[ qo.do ] );
  if ( post && post.length ) {
    var _cb = cb;
