...
var Query = require( './Query' ),
    ...
    constraints = require( './proto/constraints' ),
    modifiers = require('./proto/modifiers'),
    selectors = require('./proto/selectors'),
    paging = require( './proto/paging' ),
    sort = require( './proto/sort' ),
    relations = require( './proto/relations' );
